...
#ifndef MPTCP_STREAM_DIALOG_H
#define MPTCP_STREAM_DIALOG_H
...
#include "ui/tcp-stream-dialog.h"
...
class MPTCPStreamDialog : public TCPStreamDialog
{
    Q_OBJECT

public:
    explicit MPTCPStreamDialog(QWidget *parent = 0, capture_file *cf = NULL, tcp_graph_type graph_type = GRAPH_TSEQ_TCPTRACE);
    ~MPTCPStreamDialog();
